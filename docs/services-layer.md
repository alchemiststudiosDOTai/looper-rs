...
- [`src/services/chat_handler.rs`](/Users/tuna/looper-rs/src/services/chat_handler.rs:1)
  Defines the non-streaming trait `ChatHandler`.
- [`src/services/chat_handler_streaming.rs`](/Users/tuna/looper-rs/src/services/chat_handler_streaming.rs:1)
  Defines the streaming trait `StreamingChatHandler`.
- [`src/services/handlers/mod.rs`](/Users/tuna/looper-rs/src/services/handlers/mod.rs:1)
...
[`ChatHandler`](/Users/tuna/looper-rs/src/services/chat_handler.rs:12) defines:
...
[`StreamingChatHandler`](/Users/tuna/looper-rs/src/services/chat_handler_streaming.rs:8) defines:
...
[`OpenAIResponsesNonStreamingHandler`](/Users/tuna/looper-rs/src/services/handlers/openai_responses_non_streaming.rs:27) shows the pattern clearly:
...
- [`docs/core-agent-loop-architecture.md`](/Users/tuna/looper-rs/docs/core-agent-loop-architecture.md:1): broader architecture across `Looper`, handlers, tools, and history
- [`docs/mapping-layer.md`](/Users/tuna/looper-rs/docs/mapping-layer.md:1): the translation layer some handlers rely on for provider-native tool schemas
- [`src/looper.rs`](/Users/tuna/looper-rs/src/looper.rs:23): the non-streaming entry point that selects a `ChatHandler`
- [`src/looper_stream.rs`](/Users/tuna/looper-rs/src/looper_stream.rs:28): the streaming entry point that selects a `StreamingChatHandler`
