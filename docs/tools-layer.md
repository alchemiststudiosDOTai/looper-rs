...
[`src/tools/mod.rs`](/Users/tuna/looper-rs/src/tools/mod.rs:14) defines:
...
[`LooperTool`](/Users/tuna/looper-rs/src/tools/mod.rs:15) has three responsibilities:
...
[`LooperTools`](/Users/tuna/looper-rs/src/tools/mod.rs:22) is the surface the rest of the runtime calls.
...
1. Tool authoring
   ...
   A tool implementation returns a [`LooperToolDefinition`](/Users/tuna/looper-rs/src/types/tool.rs:4) from `tool()`.
...
In [`examples/cli_non_streaming.rs`](/Users/tuna/looper-rs/examples/cli_non_streaming.rs:141) and [`examples/cli.rs`](/Users/tuna/looper-rs/examples/cli.rs:285), the registry:
...
[`SubAgentTool`](/Users/tuna/looper-rs/src/tools/sub_agent.rs:17) is a special built-in tool that wraps another non-streaming `Looper`.
...
- [`docs/services-layer.md`](/Users/tuna/looper-rs/docs/services-layer.md:1): explains how handlers consume tool registries and execute tool calls
- [`docs/mapping-layer.md`](/Users/tuna/looper-rs/docs/mapping-layer.md:1): explains how tool definitions are translated into provider-native schemas
- [`src/types/tool.rs`](/Users/tuna/looper-rs/src/types/tool.rs:4): the shared tool definition type used by every tool
- [`src/looper.rs`](/Users/tuna/looper-rs/src/looper.rs:63): shows where builders inject `SubAgentTool` into a mutable registry
- [`src/looper_stream.rs`](/Users/tuna/looper-rs/src/looper_stream.rs:80): the streaming builder follows the same injection pattern
