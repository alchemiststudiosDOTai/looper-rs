...
At the top level, [`src/mapping/mod.rs`](/Users/tuna/looper-rs/src/mapping/mod.rs:1) exposes both submodules, but only re-exports `tools`.

## The central internal type

The whole `tools` mapping layer starts from [`LooperToolDefinition`](/Users/tuna/looper-rs/src/types/tool.rs:4).
...
[`src/mapping/tools/openai_completions.rs`](/Users/tuna/looper-rs/src/mapping/tools/openai_completions.rs:1) implements:
...
in [`src/services/handlers/openai_completions.rs`](/Users/tuna/looper-rs/src/services/handlers/openai_completions.rs:233).
...
[`src/mapping/tools/openai_responses.rs`](/Users/tuna/looper-rs/src/mapping/tools/openai_responses.rs:1) implements:
...
in [`src/services/handlers/openai_responses.rs`](/Users/tuna/looper-rs/src/services/handlers/openai_responses.rs:209).

Conceptually this is the same as the completions mapping, just against a different OpenAI SDK surface.

### Anthropic

[`src/mapping/tools/anthropic.rs`](/Users/tuna/looper-rs/src/mapping/tools/anthropic.rs:1) implements:

- `From<LooperToolDefinition> for async_anthropic::types::Tool`

The Anthropic handler uses that via plain `.into()` in [`src/services/handlers/anthropic.rs`](/Users/tuna/looper-rs/src/services/handlers/anthropic.rs:264).
...
[`src/mapping/tools/gemini.rs`](/Users/tuna/looper-rs/src/mapping/tools/gemini.rs:6) exposes a function:
...
The Gemini handlers call it directly in [`src/services/handlers/gemini.rs`](/Users/tuna/looper-rs/src/services/handlers/gemini.rs:266) and the non-streaming variant.
...
- [`src/mapping/turn/openai_completions.rs`](/Users/tuna/looper-rs/src/mapping/turn/openai_completions.rs:1)
- [`src/mapping/turn/anthropic.rs`](/Users/tuna/looper-rs/src/mapping/turn/anthropic.rs:1)
- [`src/mapping/turn/gemini.rs`](/Users/tuna/looper-rs/src/mapping/turn/gemini.rs:1)
...
- [`docs/core-agent-loop-architecture.md`](/Users/tuna/looper-rs/docs/core-agent-loop-architecture.md:1): explains where the mapping layer sits inside the larger agent loop
- [`src/types/tool.rs`](/Users/tuna/looper-rs/src/types/tool.rs:4): the shared tool schema all outbound mappings depend on
- [`src/types/turn.rs`](/Users/tuna/looper-rs/src/types/turn.rs:4): the normalized non-streaming turn model the inbound mappings target
- [`src/services/handlers`](/Users/tuna/looper-rs/src/services/handlers): the main consumers of the tool mappings
